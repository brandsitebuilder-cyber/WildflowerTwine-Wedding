        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 text-white">
              ...
              <p className="text-white/70 text-sm md:text-base font-light">Stellenbosch Winelands, Western Cape</p>
              <p className="text-white/50 text-xs mt-2 uppercase tracking-[0.1em]">On-site parking · Wheelchair accessible</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-charcoal/60 text-sm font-light leading-[2] mb-4">
            ...
            <div className="grid grid-cols-2 gap-4 text-xs">
              <div className="bg-white/50 p-4 rounded-sm">
                ...
                <span className="text-charcoal/60 font-light">Linen suits or chinos in earthy tones. Ties optional.</span>
              </div>
              <div className="bg-white/50 p-4 rounded-sm">
                <span className="font-medium block mb-1 text-charcoal">Ladies</span>
                <span className="text-charcoal/60 font-light">Flowing midi dresses, floral prints, block heels.</span>
              </div>
            </div>
          </motion.div>
        </div>
